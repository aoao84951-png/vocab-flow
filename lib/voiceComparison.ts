...
export const COMPARISON_VOICES = [
  { id: "us-wavenet", region: "미국", provider: "google", label: "기존 남성 · WaveNet", gender: "남성", voice: "en-US-Wavenet-D" },
  { id: "us-neural2", region: "미국", provider: "google", label: "다른 여성 · Neural2", gender: "여성", voice: "en-US-Neural2-F" },
  ...
  { id: "uk-wavenet", region: "영국", provider: "google", label: "기존 남성 · WaveNet", gender: "남성", voice: "en-GB-Wavenet-B" },
  { id: "uk-neural2", region: "영국", provider: "google", label: "다른 여성 · Neural2", gender: "여성", voice: "en-GB-Neural2-A" },
  ...
  { id: "au-wavenet", region: "호주", provider: "google", label: "기존 남성 · WaveNet", gender: "남성", voice: "en-AU-Wavenet-B" },
  { id: "au-neural2", region: "호주", provider: "google", label: "다른 여성 · Neural2", gender: "여성", voice: "en-AU-Neural2-A" },
