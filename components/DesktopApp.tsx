                                          ...
                                          {variant.related && (
                                            <div className="mt-2 flex items-baseline gap-1.5 pl-[1px]">
                                              ...
                                              <div className="flex min-w-0 flex-1 items-start gap-2">
                                                <PronounceButtons text={variant.related} className="ipad-study-sub relative -top-[2px] min-w-0 flex-1 text-[12px] font-bold leading-[1.5] tracking-[-0.01em] text-[#4b6cb7]">
                                                  <HighlightedText
